...
{
    [AssetAddress("UIQuestSeasonOneCollectNormalNodeReward")]
    public class SeasonQuestNormalNodeRewardView:View
    {
        ...
        public SeasonQuestNormalNodeRewardView(string address)
            : base(address)
        {
