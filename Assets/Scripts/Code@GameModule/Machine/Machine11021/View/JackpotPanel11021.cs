...
{
    public class JackpotPanel11021:JackPotPanel
    {
        ...
        public JackpotPanel11021(Transform inTransform) : base(inTransform)
        {
            ...
            { 
               ...
               animatorTips.Add(this.transform.parent.Find($"Wheels/GroupTips/JackpotTips{i+1}Group").GetComponent<Animator>());
