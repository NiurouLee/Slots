...
{
    public class WheelStateLeft11026 : WheelState
    {
        public WheelStateLeft11026(MachineState state) : base(state)
        {
        }
        ...
        { 
            ...
            int realIndex = 0;
            var realMapping = extraState.GetLeftLinkData().ReelMapping;
        ...
        public override void UpdateCurrentActiveSequence(string sequenceName, List<int> startIndex = null)
        {
            ...
            {
                var extraState = machineState.machineContext.state.Get<ExtraState11026>();
                var reelMapping = extraState.GetLeftLinkData().ReelMapping;
        ...
        {
            var extraState = machineState.machineContext.state.Get<ExtraState11026>();
            var linkData = extraState.GetLeftLinkData();
