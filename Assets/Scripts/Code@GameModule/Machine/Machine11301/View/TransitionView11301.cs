...
{
    public class TransitionView11301: TransformHolder
    {
        ...
        public TransitionView11301(Transform inTransform) : base(inTransform)
        {
            ComponentBinder.BindingComponent(this, transform);


            foreach (var item in Constant11301.DicBigElementId2Name)
            {
        ...
        public void UpdateBgAnim(bool IsFree){
            context.transform.Find("Background/BGFreeGame").gameObject.SetActive(IsFree);
            context.transform.Find("Background/BGBaseGame").gameObject.SetActive(!IsFree);
        }

        public void UpdateShopMaskShow(bool isShow){
            context.transform.Find("Background/shopMask").gameObject.SetActive(isShow);
            context.view.Get<ControlPanel>().ShowSpinButton(!isShow);
            Constant11301.IsShowShop = isShow;
