...
{
    public class UIJackpotUltraView11031 : TransformHolder
    {
        ...
        public UIJackpotUltraView11031(Transform inTransform) : base(inTransform)
        {
        ...
        public async Task ShowJackpot(ulong jackpotWin)
        {
            ...
            AudioUtil.Instance.PlayAudioFx("Ultra_Open");
