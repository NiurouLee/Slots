...
{
    public class UIJackpotMInorView11031 : TransformHolder
    {
        ...
        public UIJackpotMInorView11031(Transform inTransform) : base(inTransform)
        {
        ...
        public async Task ShowJackpot(ulong jackpotWin)
        {
            ...
            AudioUtil.Instance.PlayAudioFx("Minor_Open");
