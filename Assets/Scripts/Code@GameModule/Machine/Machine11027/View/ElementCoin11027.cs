...
{
    public class ElementCoin11027: Element
    {
        
        [ComponentBinder("IntegralText")]
        protected TextMesh txtCoin;
        
        public ElementCoin11027(Transform transform, bool inIsStatic) : base(transform, inIsStatic)
        {
        ...
        public override void UpdateOnAttachToContainer(Transform containerTransform, SequenceElement element)
        {
            ...
            if (Constant11027.ListWildElementIds.Contains(sequenceElement.config.id))
            {
