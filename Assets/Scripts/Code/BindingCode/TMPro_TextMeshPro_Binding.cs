...
{
    unsafe class TMPro_TextMeshPro_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(TMPro.TextMeshPro);
            args = new Type[]{};
        ...
        static StackObject* get_transform_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            TMPro.TextMeshPro instance_of_this_method = (TMPro.TextMeshPro)typeof(TMPro.TextMeshPro).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
