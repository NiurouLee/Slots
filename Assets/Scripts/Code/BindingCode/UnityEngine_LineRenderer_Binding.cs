...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_LineRenderer_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetPositions_2);
            args = new Type[]{typeof(UnityEngine.Color)};
            method = type.GetMethod("set_startColor", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_startColor_3);
            args = new Type[]{};
            method = type.GetMethod("get_startColor", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_startColor_4);
            args = new Type[]{typeof(UnityEngine.Color)};
            method = type.GetMethod("set_endColor", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_endColor_5);
        ...
        static StackObject* SetPositions_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* set_startColor_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* get_startColor_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* set_endColor_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
