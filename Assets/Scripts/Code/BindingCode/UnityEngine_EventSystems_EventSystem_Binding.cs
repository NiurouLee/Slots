...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_EventSystems_EventSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, SetSelectedGameObject_1);
            args = new Type[]{};
            method = type.GetMethod("get_currentSelectedGameObject", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_currentSelectedGameObject_2);
        ...
        static StackObject* SetSelectedGameObject_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* get_currentSelectedGameObject_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
