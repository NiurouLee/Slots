...
{
    unsafe class Google_ilruntime_Protobuf_ByteString_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Google.ilruntime.Protobuf.ByteString);
            args = new Type[]{};
            ...
            args = new Type[]{typeof(Google.ilruntime.Protobuf.ByteString), typeof(Google.ilruntime.Protobuf.ByteString)};
            method = type.GetMethod("op_Equality", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, op_Equality_2);
            args = new Type[]{};
            method = type.GetMethod("ToByteArray", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToByteArray_3);
            args = new Type[]{typeof(Google.ilruntime.Protobuf.ByteString), typeof(Google.ilruntime.Protobuf.ByteString)};
        ...
        static StackObject* get_Length_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.ilruntime.Protobuf.ByteString instance_of_this_method = (Google.ilruntime.Protobuf.ByteString)typeof(Google.ilruntime.Protobuf.ByteString).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
        ...
        static StackObject* get_Empty_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = Google.ilruntime.Protobuf.ByteString.Empty;
        ...
        static StackObject* op_Equality_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            Google.ilruntime.Protobuf.ByteString @rhs = (Google.ilruntime.Protobuf.ByteString)typeof(Google.ilruntime.Protobuf.ByteString).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);

            ptr_of_this_method = ILIntepreter.Minus(__esp, 2);
            Google.ilruntime.Protobuf.ByteString @lhs = (Google.ilruntime.Protobuf.ByteString)typeof(Google.ilruntime.Protobuf.ByteString).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* ToByteArray_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Google.ilruntime.Protobuf.ByteString(@bytes);
