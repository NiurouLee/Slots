...
{
    unsafe class System_Collections_Generic_Dictionary_2_String_APIEntry_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Collections.Generic.Dictionary<System.String, DragonU3DSDK.Network.API.APIEntry>);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ContainsKey", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ContainsKey_0);
            args = new Type[]{typeof(System.String), typeof(DragonU3DSDK.Network.API.APIEntry)};
        ...
        static StackObject* ContainsKey_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Collections.Generic.Dictionary<System.String, DragonU3DSDK.Network.API.APIEntry> instance_of_this_method = (System.Collections.Generic.Dictionary<System.String, DragonU3DSDK.Network.API.APIEntry>)typeof(System.Collections.Generic.Dictionary<System.String, DragonU3DSDK.Network.API.APIEntry>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Add_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            DragonU3DSDK.Network.API.APIEntry @value = (DragonU3DSDK.Network.API.APIEntry)typeof(DragonU3DSDK.Network.API.APIEntry).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
