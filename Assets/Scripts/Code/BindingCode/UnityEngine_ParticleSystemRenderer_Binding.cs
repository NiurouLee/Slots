...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_ParticleSystemRenderer_Binding
    {
        ...
        static StackObject* set_maskInteraction_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            UnityEngine.ParticleSystemRenderer instance_of_this_method = (UnityEngine.ParticleSystemRenderer)typeof(UnityEngine.ParticleSystemRenderer).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
