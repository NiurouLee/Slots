...
{
    unsafe class Google_ilruntime_Protobuf_Collections_RepeatedField_1_String_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            FieldInfo field;
            Type[] args;
            Type type = typeof(Google.ilruntime.Protobuf.Collections.RepeatedField<System.String>);
            args = new Type[]{typeof(Google.ilruntime.Protobuf.CodedOutputStream), typeof(Google.ilruntime.Protobuf.FieldCodec<System.String>)};
            method = type.GetMethod("WriteTo", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WriteTo_0);
            args = new Type[]{typeof(Google.ilruntime.Protobuf.FieldCodec<System.String>)};
            method = type.GetMethod("CalculateSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CalculateSize_1);
            args = new Type[]{typeof(Google.ilruntime.Protobuf.CodedInputStream), typeof(Google.ilruntime.Protobuf.FieldCodec<System.String>)};
        ...
        static StackObject* WriteTo_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.ilruntime.Protobuf.FieldCodec<System.String> @codec = (Google.ilruntime.Protobuf.FieldCodec<System.String>)typeof(Google.ilruntime.Protobuf.FieldCodec<System.String>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            Google.ilruntime.Protobuf.Collections.RepeatedField<System.String> instance_of_this_method = (Google.ilruntime.Protobuf.Collections.RepeatedField<System.String>)typeof(Google.ilruntime.Protobuf.Collections.RepeatedField<System.String>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        {
            return ((Google.ilruntime.Protobuf.Collections.RepeatedField<System.String>)o).array;
        }

        static StackObject* CopyToStack_array_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
            var result_of_this_method = ((Google.ilruntime.Protobuf.Collections.RepeatedField<System.String>)o).array;
            return ILIntepreter.PushObject(__ret, __mStack, result_of_this_method);
        }

        static void set_array_0(ref object o, object v)
        {
            ((Google.ilruntime.Protobuf.Collections.RepeatedField<System.String>)o).array = (System.String[])v;
        }
        ...
        static StackObject* AssignFromStack_array_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ...
            ((Google.ilruntime.Protobuf.Collections.RepeatedField<System.String>)o).array = @array;
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Google.ilruntime.Protobuf.Collections.RepeatedField<System.String>();
