...
{
    unsafe class ILRuntime_Reflection_ILRuntimeType_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.Reflection.ILRuntimeType);
            args = new Type[]{};
            method = type.GetMethod("get_ILType", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_ILType_0);
