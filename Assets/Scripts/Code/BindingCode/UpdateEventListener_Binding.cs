...
{
    unsafe class UpdateEventListener_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::UpdateEventListener);
            ...
            args = new Type[]{typeof(System.Action)};
            method = type.GetMethod("set_OnFixedUpdate", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_OnFixedUpdate_2);
        ...
        static StackObject* set_OnUpdate_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::UpdateEventListener.OnUpdate = value;
        ...
        static StackObject* set_OnLateUpdate_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::UpdateEventListener.OnLateUpdate = value;

            return __ret;
        }

        static StackObject* set_OnFixedUpdate_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            global::UpdateEventListener.OnFixedUpdate = value;
