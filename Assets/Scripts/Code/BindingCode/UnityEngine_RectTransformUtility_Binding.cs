...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_RectTransformUtility_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, RectangleContainsScreenPoint_1);
            args = new Type[]{typeof(UnityEngine.RectTransform), typeof(UnityEngine.Vector2)};
            method = type.GetMethod("RectangleContainsScreenPoint", flag, null, args, null);
        ...
        static StackObject* RectangleContainsScreenPoint_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* RectangleContainsScreenPoint_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = UnityEngine.RectTransformUtility.RectangleContainsScreenPoint(@rect, @screenPoint);
