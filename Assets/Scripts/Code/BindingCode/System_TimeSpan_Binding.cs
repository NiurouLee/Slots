...
namespace ILRuntime.Runtime.Generated
{
    unsafe class System_TimeSpan_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, FromSeconds_2);
            args = new Type[]{};
            method = type.GetMethod("get_TotalDays", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_TotalDays_3);
            ...
            app.RegisterCLRMethodRedirection(method, get_TotalHours_5);
            args = new Type[]{};
            method = type.GetMethod("get_TotalMilliseconds", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_TotalMilliseconds_6);
            args = new Type[]{typeof(System.Double)};
            method = type.GetMethod("FromMilliseconds", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, FromMilliseconds_7);
            args = new Type[]{};
            method = type.GetMethod("get_Milliseconds", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Milliseconds_8);
            args = new Type[]{typeof(System.Double)};
        ...
        static StackObject* FromSeconds_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_TotalDays_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_TotalHours_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_TotalMilliseconds_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* FromMilliseconds_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* get_Milliseconds_8(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
