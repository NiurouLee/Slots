...
{
    unsafe class Google_ilruntime_Protobuf_MessageParser_1_Adapt_IMessage_Binding_Adaptor_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Google.ilruntime.Protobuf.MessageParser<global::Adapt_IMessage.Adaptor>);
        ...
        static StackObject* ParseFrom_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.ilruntime.Protobuf.MessageParser<global::Adapt_IMessage.Adaptor> instance_of_this_method = (Google.ilruntime.Protobuf.MessageParser<global::Adapt_IMessage.Adaptor>)typeof(Google.ilruntime.Protobuf.MessageParser<global::Adapt_IMessage.Adaptor>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Google.ilruntime.Protobuf.MessageParser<global::Adapt_IMessage.Adaptor>(@factory);
