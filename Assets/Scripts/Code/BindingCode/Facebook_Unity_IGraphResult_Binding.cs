...
{
    unsafe class Facebook_Unity_IGraphResult_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Facebook.Unity.IGraphResult);
            args = new Type[]{};
        ...
        static StackObject* get_Texture_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Facebook.Unity.IGraphResult instance_of_this_method = (Facebook.Unity.IGraphResult)typeof(Facebook.Unity.IGraphResult).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
