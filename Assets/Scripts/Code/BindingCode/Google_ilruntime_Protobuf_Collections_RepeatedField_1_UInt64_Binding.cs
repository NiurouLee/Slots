...
{
    unsafe class Google_ilruntime_Protobuf_Collections_RepeatedField_1_UInt64_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Google.ilruntime.Protobuf.Collections.RepeatedField<System.UInt64>);
            args = new Type[]{typeof(Google.ilruntime.Protobuf.CodedOutputStream), typeof(Google.ilruntime.Protobuf.FieldCodec<System.UInt64>)};
            method = type.GetMethod("WriteTo", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, WriteTo_0);
            args = new Type[]{typeof(Google.ilruntime.Protobuf.FieldCodec<System.UInt64>)};
            method = type.GetMethod("CalculateSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, CalculateSize_1);
            args = new Type[]{typeof(Google.ilruntime.Protobuf.CodedInputStream), typeof(Google.ilruntime.Protobuf.FieldCodec<System.UInt64>)};
        ...
        static StackObject* WriteTo_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Google.ilruntime.Protobuf.FieldCodec<System.UInt64> @codec = (Google.ilruntime.Protobuf.FieldCodec<System.UInt64>)typeof(Google.ilruntime.Protobuf.FieldCodec<System.UInt64>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            Google.ilruntime.Protobuf.Collections.RepeatedField<System.UInt64> instance_of_this_method = (Google.ilruntime.Protobuf.Collections.RepeatedField<System.UInt64>)typeof(Google.ilruntime.Protobuf.Collections.RepeatedField<System.UInt64>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new Google.ilruntime.Protobuf.Collections.RepeatedField<System.UInt64>();
