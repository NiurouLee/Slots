...
{
    unsafe class ILRuntime_CLR_TypeSystem_CLRType_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ILRuntime.CLR.TypeSystem.CLRType);
            args = new Type[]{};
            method = type.GetMethod("get_GenericArguments", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_GenericArguments_0);
