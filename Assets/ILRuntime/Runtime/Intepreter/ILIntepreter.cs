                            ...
                            case OpCodeEnum.Isinst:
                                {
                                    ...
                                    if (type != null)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (obj != null)
                                            {
                                                if (obj is ILTypeInstance && ((ILTypeInstance)obj).Type != null)
                                                {
...
#region Stack operation
                    ...
                    {
                        if (method != null && method.Definition != null &&
                            !string.IsNullOrEmpty(method.Definition.FullName))
                        {
                            Debug.LogError("[ILException]:" + method.Definition.FullName);
                        }
