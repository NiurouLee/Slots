...
public class FindCrossReferenceAssets : EditorWindow
{
    private const string MenuItemName = "Assets/查找资源交叉引用";
    ...
    public static void FinNoReferenceAssets()
    {
        ...
        if (Regex.IsMatch(clickedPath, parttern))
        {
            ...
            FindReferenceByIndex(files.ToList(), 0, () =>
            {
                ...
                FindCrossReferenceAssets window =
                    (FindCrossReferenceAssets) EditorWindow.GetWindow(typeof(FindCrossReferenceAssets), false,
