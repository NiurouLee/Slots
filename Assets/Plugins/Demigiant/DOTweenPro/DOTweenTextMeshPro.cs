...
namespace DG.Tweening
{
    ...
    public static class ShortcutExtensionsTMPText
    {
        ...
        public static TweenerCore<long, long, NoOptions> DOCounter(
            this TMP_Text target, long fromValue, long endValue, float duration, bool addThousandsSeparator = true, CultureInfo culture = null
        )
        {
            long v = fromValue;
            CultureInfo cInfo = !addThousandsSeparator ? null : culture ?? CultureInfo.InvariantCulture;
            TweenerCore<long, long, NoOptions> t = DOTween.To(() => v, x => {
                v = x;
                target.text = addThousandsSeparator
                    ? v.ToString("N0", cInfo)
                    : v.ToString();
