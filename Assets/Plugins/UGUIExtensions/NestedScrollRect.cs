...
public class NestedScrollRect : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    public ContentScrollSnapHorizontal scrollSnapHorizontal;
    ...
    void Awake ()
    {
        ...
        if (scrollSnapHorizontal == null && anotherScrollRect!=null)
        {
            scrollSnapHorizontal = anotherScrollRect.GetComponent<ContentScrollSnapHorizontal>();
        }
    }
    ...
    public void OnBeginDrag (PointerEventData eventData)
    {
        ...
        scrollSnapHorizontal?.OnBeginDrag(eventData);
    }
    ...
    public void OnEndDrag (PointerEventData eventData)
    {
        ...
        scrollSnapHorizontal?.OnEndDrag(eventData);
    }
}