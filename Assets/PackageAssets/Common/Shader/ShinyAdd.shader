	...
	//	Blend SrcAlpha OneMinusSrcAlpha
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN) : SV_Target
			{
				...
				half3 reflectColor = lerp(_ShinyColor.rgb, color.rgb * 5, _ShinyHighlight);
				...
				//color.rgb = shinePower;
			 	color.rgb = sumColor * originAlpha * shinePower * _ShinyBrightness * reflectColor;
				return color;
			}
		ENDCG
		}
