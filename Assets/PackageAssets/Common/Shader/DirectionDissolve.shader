Shader "DirectionDissolve"
{
	Properties
	{
		...
		_DissolveRotation("DissolveRotation", Range(0,360)) = 0 
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			v2f vert(appdata_t IN)
			{
				...
				float rotationRadians = _DissolveRotation * Deg2Rad; // convert degrees to radians
